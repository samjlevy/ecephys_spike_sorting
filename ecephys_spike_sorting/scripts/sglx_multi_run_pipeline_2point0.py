...
# set for each run
base_dir = '//oak-smb-giocomo.stanford.edu/groups/giocomo/emijones/Chronic_NPX_Troubleshooting/2_probe_pilot/'
...
imro_dir = os.path.join(base_dir,'IMRO')
...
for i, row in sessions.iterrows():
    ...
    run_specs = [							
                            # [rec_file_stem, '0,3', '0,0', '1', ['cortex']]		
    ...
    # chanMap_list = ['Orville_HPC2', 'Orville_MEC']
