...
for a, row in sessions.iloc[12:28].iterrows(): #LT: [12:28] remapping: [np.arange(28,108,4)] #[np.arange(109,347,4)] #349-350 concat #[np.arange(354,428,4)] #429:
# remaining: change line 189 back, do 349-350 concat
    try:
        print(row['File'])
        ...
        run_specs = [							
                                [rec_file_stem, '0,0', '0,0', '0,1', ['cortex','cortex']]	
