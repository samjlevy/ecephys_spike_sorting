...
# set for each run
base_dir = '//oak-smb-giocomo.stanford.edu/groups/giocomo/emijones/WT_Sequences/2022_winter/'
...
#####processed_data_dir = '//oak-smb-giocomo.stanford.edu/groups/giocomo/emijones/WT_Sequences/ecephys_scratch'
